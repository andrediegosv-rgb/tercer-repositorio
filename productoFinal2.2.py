...
def abrir_registro_productos():
    ...
    def guardar_producto():
        ...
        with open(ruta_archivo, "a", encoding="utf-8") as archivo_txt:
    ...
    # --- Botón Guardar ---
    btn_guardar = tk.Button(reg, text="Guardar Producto", font=("Arial", 12), bg="black", fg="white", command=guardar_producto)
...
def abrir_registro_ventas():
    ...
    ven.cantidad_var = cantidad_var   # mantiene referencia
...
try:
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    imagen = Image.open(os.path.join(BASE_DIR, "Imagen1.jpg"))
...
# BOTONES PRINCIPALES
# -------------------------
btn_reg_prod = ttk.Button(ventana, text="Registro de Productos", command=abrir_registro_productos, style="Negro.TButton")
btn_reg_prod.pack(pady=10)

btn_reg_ventas = ttk.Button(ventana, text="Registro de Ventas", command=abrir_registro_ventas, style="Negro.TButton")
btn_reg_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes", command=abrir_reportes, style="Negro.TButton")
btn_reportes.pack(pady=10)

btn_acerca = ttk.Button(ventana, text="Acerca de", command=abrir_acerca_de, style="Negro.TButton")
